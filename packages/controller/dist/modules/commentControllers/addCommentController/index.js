                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (typeof response !== "undefined" &&
                            ...
                            result = response.data.createComment;
                            if (!result.error) {
...
var addCommentMutation = gql(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  mutation AddCommentMutation($content: String!, $snippetId: String!) {\n    createComment(snippetId: $snippetId, content: $content) {\n      ... on Comment {\n        id\n        content\n        user\n        createdAt\n      }\n      ... on ContentError {\n        error\n        message\n      }\n    }\n  }\n"], ["\n  mutation AddCommentMutation($content: String!, $snippetId: String!) {\n    createComment(snippetId: $snippetId, content: $content) {\n      ... on Comment {\n        id\n        content\n        user\n        createdAt\n      }\n      ... on ContentError {\n        error\n        message\n      }\n    }\n  }\n"])));
export var AddCommentController = graphql(addCommentMutation)(C);
