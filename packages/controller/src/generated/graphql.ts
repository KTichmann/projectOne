...
export interface CommentResolvers<
	ContextType = any,
	ParentType = ResolversParentTypes["Comment"]
> {
...
export interface CommentOrErrorResolvers<
	ContextType = any,
	ParentType = ResolversParentTypes["CommentOrError"]
> {
...
export interface ContentErrorResolvers<
	ContextType = any,
	ParentType = ResolversParentTypes["ContentError"]
> {
...
export interface SnippetResolvers<
	ContextType = any,
	ParentType = ResolversParentTypes["Snippet"]
> {
	id?: Resolver<ResolversTypes["ID"], ParentType, ContextType>;
	content?: Resolver<ResolversTypes["String"], ParentType, ContextType>;
...
export interface SnippetOrErrorResolvers<
	ContextType = any,
	ParentType = ResolversParentTypes["SnippetOrError"]
> {
	__resolveType: TypeResolveFn<
