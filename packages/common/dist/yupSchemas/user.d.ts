...
export declare const passwordNotLongEnough =
	"password must be at least 3 characters";
export declare const userEmailSchema: yup.ObjectSchema<
	yup.Shape<
		object,
		{
			email: string;
	...
	>
>;
export declare const userPasswordSchema: yup.ObjectSchema<
	yup.Shape<
		object,
		{
			password: string;
